...
; ==================================================================
	...
	%DEFINE PATHOS_VER '0.0.5'	; OS version number
...
; use a PathOS system call without having to know its exact position
...
os_main:
	...
	mov es, ax			; segments ever again, as PathOS and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to PathOS', 0
	os_version_msg		db 'Version ', PATHOS_VER, 0
